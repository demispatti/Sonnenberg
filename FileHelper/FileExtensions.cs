...
namespace Sonnenberg.FileHelper
{
    ...
    public class FileExtensions
    {
        ...
        {
            "AudioFiles", "BackupFiles", "CadFiles", "CameraRawFiles", "CodeFiles", "CompressedFiles", "DatabaseFiles", "DataFiles", "DeveloperFiles",
            "DiskImageFiles", "EbookFiles", "EncodedFiles", "ExecutableFiles", "FontFiles", "GameFiles", "GisFiles", "MiscFiles", "PageLayoutFiles",
            "PluginFiles", "RasterImageFiles", "SettingsFiles", "SpreadsheetFiles", "SystemFiles", "TextFiles", "VectorImageFiles", "VideoFiles", "WebFiles"
        });
        ...
        {
            "CodeFiles", "DatabaseFiles", "DataFiles", "DeveloperFiles", "DiskImageFiles", "EbookFiles", "EncodedFiles", "ExecutableFiles", "GisFiles", "MiscFiles",
        ...
        private static List<string> SetFileTypesExtensionsList(IEnumerable<string> fileTypesList)
        {
            ...
            {
                list.AddRange(GetFileTypeExtensionsList(fileType));
            }
        ...
        private static IEnumerable<string> GetFileTypeExtensionsList(string type)
        {
            ...
            var resourceName = $"Sonnenberg.FileHelper.Resources.Files.{type}Extensions.json";

            if (! manifestResourcesList.Contains(resourceName))
            {
                log.Error($"Resource not found:  + resourceName + (FileExtensions/ type: {type}, ResourceName: {resourceName})");
                
                throw new FileNotFoundException($"Resource not found:  + resourceName + (FileExtensions/ type: {type}, ResourceName: {resourceName})");
            }

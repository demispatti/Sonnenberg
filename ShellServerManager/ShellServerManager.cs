...
namespace Sonnenberg.ServerManager
{
    ...
    public class ShellServerManager
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(ShellServerManager));

        public ShellServerManager()
        {
            ConfigureLogger();
        }
        ...
        /// </summary>
        /// <param name="server"></param>
        public void StartShellServer(ShellServer.ShellServer server)
        {
            Start(server);
        }
        ...
        /// </summary>
        /// <param name="server"></param>
        public void StopShellServer(ShellServer.ShellServer server)
        {
            Stop(server);
        }
    }
